...
# -*- coding: utf-8 -*-
"""
Offset of the residue amplifier
@author: yuanzx
"""
...
# with amplifier offset
gain_error = 0.0
amp_offset = math.pow(2,-Nbit0)*1.5
gain = math.pow(2,Nbit0-2)*(1+gain_error)
...
plt.plot(rvin,rdout0,color="red",  linewidth=1.5, linestyle="-",label=r'wo/ amp offset')
plt.plot(ivin,idout0,color="green",  linewidth=1., linestyle="-",label=r'w/ amp offset')
plt.legend(loc='upper left', frameon=False)

plt.plot(rvin,rdout1,color="red",  linewidth=1.5, linestyle="-",label='wo/ amp offset')
plt.plot(ivin,idout1,color="green",  linewidth=1., linestyle="-",label='w/ amp offset')
...
plt.figure(figsize=(7,5),dpi=150)
plt.plot(ivin,idout,color="green",  linewidth=1.5, linestyle="-",label=r'wo/ amp offset')
plt.plot(rvin,rdout,color="red",  linewidth=1.5, linestyle="-",label=r'w/ amp offset')
plt.legend(loc='upper left', frameon=False)
plt.xlabel(r'$V_{in}$')
plt.xlim(-1.15,1.15)
plt.xticks([-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1],
