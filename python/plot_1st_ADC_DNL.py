...
plt.plot(rvin,rdout0,color="red",  linewidth=1.5, linestyle="-",label=r'wo/ 1st ADC DNL')
plt.plot(ivin,idout0,color="green",  linewidth=1., linestyle="-",label=r'w/ 1st ADC DNL')
plt.legend(loc='upper left', frameon=False)
plt.plot(rvin,rdout1,color="red",  linewidth=1.5, linestyle="-",label='wo/ 1st ADC DNL')
plt.plot(ivin,idout1,color="green",  linewidth=1., linestyle="-",label='w/ 1st ADC DNL')
...
plt.figure(figsize=(7,5),dpi=150)
plt.plot(ivin,idout,color="green",  linewidth=1.5, linestyle="-",label=r'wo/ 1st ADC DNL')
plt.plot(rvin,rdout,color="red",  linewidth=1.5, linestyle="-",label=r'w/ 1st ADC DNL')
plt.legend(loc='upper left', frameon=False)
plt.xlabel(r'$V_{in}$')
plt.xlim(-1.15,1.15)
plt.xticks([-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1],
